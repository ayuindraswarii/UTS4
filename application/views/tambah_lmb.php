				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title" align="center">Tambah Data Lomba</h3>
						</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-group">
					                  ...
					                  <input type="text" class="form-control" name="kode_lomba">
					                </div>
					                <div class="form-group">
					                ...
					                <a href="<?php echo base_url();?>index.php/Lomba" class="btn btn-info" style="float: left;"><span class="glyphicon glyphicon-arrow-left"></span> Back</a>
