	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="<?php echo base_url();?>index.php/Template" class="active"><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title" align="center">Welcome <?php echo $this->session->userdata('nama_user'); ?></h3>
						</div>
					</div>
					<!-- END OVERVIEW -->
				</div>
		...
		<footer>
			<div class="container-fluid">
				<p class="copyright">&copy; 2017 <a href="<?php base_url();?>https://www.themeineed.com" target="_blank">Theme I Need</a>. All Rights Reserved.</p>
			</div>
		</footer>
	</div>
	<!-- END WRAPPER -->
