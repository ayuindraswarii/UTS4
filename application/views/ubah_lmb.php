					...
					<div class="panel panel-headline">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12">
									<?php extract($lmb); ?>
						              <form method="POST" action="<?php echo base_url();?>index.php/Lomba/update/<?php echo $kode_lomba;?>">
						                <div class="form-group">
						                  <label>Kode Lomba</label>
						                  <input type="text" class="form-control" value="<?php echo $kode_lomba;?>" name="kode_lomba">
						                </div>
						                <div class="form-group">
						                  <label>Nama Lomba</label>
						                  <input type="text" class="form-control" value="<?php echo $nama_lomba;?>" name="nama_lomba">
						                </div>
						                <div class="form-group">
						                  <label>Harga</label>
						                  <input type="text" class="form-control" value="<?php echo $harga;?>" name="harga">
						                </div>
						                <a href="<?php echo base_url();?>index.php/Lomba" class="btn btn-danger" style="float: left;"><span class="glyphicon glyphicon-remove-circle"></span> Cancel</a>
