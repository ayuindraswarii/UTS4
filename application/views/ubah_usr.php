				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title" align="center">Ubah Data Lomba</h3>
						</div>
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12">
									<?php extract($usr); ?>
						              <form method="POST" action="<?php echo base_url();?>index.php/User/update/<?php echo $kode_user;?>">
						                <div class="form-group">
						                  <label>Kode User</label>
						                  <input type="text" class="form-control" value="<?php echo $kode_user;?>" name="kode_user">
						                </div>
						                <div class="form-group">
						                  <label>Nama User</label>
						                  <input type="text" class="form-control" value="<?php echo $nama_user;?>" name="nama_user">
						                </div>
						                <div class="form-group">
						                  <label>Username</label>
						                  <input type="text" class="form-control" value="<?php echo $username_user;?>" name="username_user">
						                </div>
						                <div class="form-group">
						                  <label>Password</label>
						                  <input type="text" class="form-control" value="<?php echo $password_user;?>" name="password_user">
						                </div>
						                <a href="<?php echo base_url();?>index.php/User" class="btn btn-danger" style="float: left;"><span class="glyphicon glyphicon-remove-circle"></span> Cancel</a>
