				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title" align="center">Ubah Data Peserta</h3>
						</div>
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12">
									<?php extract($pst); ?>
						              <form method="POST" action="<?php echo base_url();?>index.php/Peserta/update/<?php echo $kode_peserta;?>">
						                ...
						                <a href="<?php echo base_url();?>index.php/Peserta" class="btn btn-danger" style="float: left;"><span class="glyphicon glyphicon-remove-circle"></span> Cancel</a>
